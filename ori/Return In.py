...
template_path = r"C:\Template\入库.xlsx"
...
base_filename = f"入库_return_{today_str}"
...
source_ws = source_wb["Return"]

# Load template workbook and use the first sheet
template_wb = load_workbook(template_path)
template_ws = template_wb.active

# Define column and row ranges (columns: 7-9, starting from row 3)
start_col = 7
end_col = 9
start_row = 3

# Find the last non-empty row in columns 
...
# Copy data from source to template 
